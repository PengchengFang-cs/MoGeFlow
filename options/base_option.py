...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--data_root', type=str, default='',
                                 help='Override dataset root directory. Empty means using built-in defaults.')
        self.parser.add_argument('--num_workers', type=int, default=4, help='DataLoader worker processes')
        self.parser.add_argument('--skip_eval', action='store_true',
                                 help='Skip evaluator loader/wrapper and evaluation during training')
