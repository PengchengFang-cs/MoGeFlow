...
# Token-only Qwen3 norm-average text conditioning (no CLIP / no pooled branch).
# Identical to train_humanml3d_pscf_standard.sh except the text provider.
...
RUN_NAME="${RUN_NAME:-codeflow_pscf_hml3d_qwennormavg_codebook_h1152_p192_bs32x2}"
...
TEXT_CACHE_PATH="${TEXT_CACHE_PATH:-/scratch/pf2m24/text-caches/humanml3d_qwen3_8b_normavg_userchat_l128_v1}"
