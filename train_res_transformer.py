...
if __name__ == '__main__':
    ...
    opt = parser.parse()
    if getattr(opt, 'res_train_with_base_pred', False):
    ...
    val_loader = DataLoader(val_dataset, batch_size=opt.batch_size, num_workers=opt.num_workers, shuffle=True, drop_last=False)
